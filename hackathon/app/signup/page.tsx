  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5">
        <div className="flex h-60 cursor-pointer flex-col justify-between rounded-md bg-[#8F00FF] p-10">
          <Image src={ICON_NEW} width={48} height={48} alt="청년" />
          <div className="text-2xl font-semibold text-white">청년이에요</div>
        </div>
        <div className="flex h-60 cursor-pointer flex-col justify-between rounded-md bg-[#35FF6E] p-10">
